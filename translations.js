export const TRANSLATIONS = {
  en: {
    ...
    dropzoneSubtitle: "Supports PNG, JPG, WEBP (Max 10MB)",
    browseFilesBtn: "Browse Files",
    useCameraBtn: "📷 Use Camera",
    sampleHeader: "Or click a sample leaf to test:",
    
    awaitingTitle: "Awaiting Leaf Image",
    awaitingDesc: "Upload a leaf photo or pick a sample card from the left gallery to generate disease diagnostic breakdown and medicine recommendations.",
    scanningText: "Analyzing Chlorosis & Fungal Patterns...",
    
    tabRootCause: "Symptoms & Root Cause",
    ...
    sendBtn: "Send",
    chatWelcome: "Hello! I'm your AI Agronomist. Ask me any question about Watermelon, Banana, Papaya, Okra, Brinjal, Onion, Rice, Chilli, or Cotton diseases!",
    
    weatherSectionHeader: "Location Weather & Disease Risk Forecast",
    weatherSectionSub: "Enter your location, district, or town to forecast local weather conditions and predict potential fungal, bacterial, or insect disease outbreaks.",
    weatherLocationPlaceholder: "Enter City/District (e.g. Guntur, Warangal, Vijayawada, Kurnool, Hyderabad, Anantapur)",
    searchWeatherBtn: "🔍 Check Weather Risk",
    gpsLocationBtn: "📍 Use My GPS Location",
    tempLabel: "Temperature",
    humidityLabel: "Humidity",
    windLabel: "Wind Speed",
    predictedDiseasesHeader: "🦠 Predicted High-Risk Crop Diseases for this Location",
    preemptiveAdvisoryHeader: "🛡️ Preemptive Agronomist Spray Advisory",

    libraryHeader: "Fruits, Vegetables & Crops Pathology Index",
    librarySub: "Explore common plant diseases, pathogens, symptoms, and approved cures across major fruits, vegetables, and crops.",
    
    calcHeader: "Fungicide Spray & Water Volume Calculator",
    calcSub: "Calculate precise water spray volume and fungicide dilution required for your field size.",
    calcAreaLabel: "Field Area / Crop Size (Acres)",
    calcRateLabel: "Recommended Dosage Rate (g or ml / Liter)",
    calcVolResultLabel: "Required Tank Water & Spray Volume",
    calcMedResultLabel: "Total Required Medicine / Fungicide Quantity",
    
    organicBadge: "🌿 Organic Solution",
    chemicalBadge: "🧪 Chemical Solution",
    ...
    faqA3: "Yes! Crop Care AI works smoothly on all mobile web browsers, iPhones, and Android devices without requiring any app download."
  },
  te: {
    ...
    navPredictor: "రోగ నిర్ధారణ కేంద్రం",
    navWeather: "🌤️ ప్రాంతీయ వాతావరణం",
    ...
    dropzoneSubtitle: "PNG, JPG, WEBP ఆమోదించబడతాయి (గరిష్టంగా 10MB)",
    browseFilesBtn: "ఫైళ్లను ఎంచుకోండి",
    useCameraBtn: "📷 కెమెరా ఉపయోగించండి",
    sampleHeader: "లేదా పరీక్షించడానికి ఒక నమూనా ఆకును క్లిక్ చేయండి:",
    
    awaitingTitle: "ఆకు చిత్రం కోసం నిరీక్షిస్తోంది",
    awaitingDesc: "వ్యాధి నిర్ధారణ మరియు మందుల సిఫార్సులను పొందడానికి ఆకు ఫోటోను అప్‌లోడ్ చేయండి లేదా నమూనా కార్డును ఎంచుకోండి.",
    scanningText: "ఆకు మచ్చలు మరియు శిలీంధ్ర నమూనాలను విశ్లేషిస్తోంది...",
    
    tabRootCause: "లక్షణాలు & మూల కారణాలు",
    ...
    sendBtn: "పంపండి",
    chatWelcome: "నమస్కారం! నేను మీ AI వ్యవసాయ నిపుణుడిని. పుచ్చకాయ, అరటి, బొప్పాయి, బెండ, వంకాయ, ఉల్లి లేదా మామిడి తెగుళ్ల గురించి నన్ను ఏమైనా అడగండి!",
    
    weatherSectionHeader: "ప్రాంతీయ వాతావరణం & పంట తెగుళ్ల ముందస్తు అంచనా",
    weatherSectionSub: "మీ గ్రామం లేదా జిల్లా పేరును నమోదు చేసి ప్రాంతీయ వాతావరణం మరియు వచ్చే వ్యాధుల ముందస్తు ప్రమాదాన్ని తెలుసుకోండి.",
    weatherLocationPlaceholder: "గ్రామం/జిల్లా పేరును నమోదు చేయండి (ఉదా: గుంటూరు, వరంగల్, విజయవాడ, కర్నూలు)",
    searchWeatherBtn: "🔍 వాతావరణ తెగులు ప్రమాదాన్ని తనిఖీ చేయండి",
    gpsLocationBtn: "📍 నా ప్రస్తుత స్థానాన్ని (GPS) ఉపయోగించండి",
    tempLabel: "ఉష్ణోగ్రత",
    humidityLabel: "గాలిలో తేమ",
    windLabel: "గాలి వేగం",
    predictedDiseasesHeader: "🦠 ఈ ప్రాంతంలో వ్యాపించే అవకాశం ఉన్న ప్రధాన పంట తెగుళ్లు",
    preemptiveAdvisoryHeader: "🛡️ ముందస్తు వ్యవసాయ నిపుణుల పిచికారీ సలహా",

    libraryHeader: "పండ్లు, కూరగాయలు & పంటల వ్యాధుల సమాచారం",
    librarySub: "మన ప్రాంతంలో పండించే పండ్లు, కూరగాయలు మరియు పంటలలో కనిపించే వ్యాధులు, వాటి నివారణ మార్గాలను తెలుసుకోండి.",
    
    calcHeader: "పిచికారీ నీరు & మందుల మోతాదు లెక్కింపు యంత్రం",
    calcSub: "మీ పొలం విస్తీర్ణానికి కావలసిన పిచికారీ నీరు మరియు మందుల ఖచ్చితమైన పరిమాణాన్ని లెక్కించండి.",
    calcAreaLabel: "పొలం విస్తీర్ణం (ఎకరాలలో)",
    calcRateLabel: "సిఫార్సు చేసిన మందుల మోతాదు (లీటరుకు గ్రాములు/మి.లీ)",
    calcVolResultLabel: "కావలసిన మొత్తం పిచికారీ నీరు",
    calcMedResultLabel: "కావలసిన మొత్తం మందుల పరిమాణం",
    
    organicBadge: "🌿 సేంద్రీయ నివారణ",
    chemicalBadge: "🧪 రసాయన మందు",
    ...
    faqA3: "అవును! ఎలాంటి యాప్ డౌన్‌లోడ్ లేకుండానే మీ మొబైల్ బ్రౌజర్‌లో నేరుగా వాడవచ్చు."
  }
};

export const TELUGU_DISEASE_DATA = {
  watermelon_anthracnose: {
    diseaseName: "పుచ్చకాయ నల్ల మచ్చ & వాడిపోయే తెగులు (Watermelon Anthracnose & Wilt)",
    symptoms: [
      "ఆకులపై నీరు పట్టినట్లు గోధుమ లేదా నల్లటి గుండ్రటి మచ్చలు ఏర్పడటం",
      "పుచ్చకాయ కాయల పైన గుంట పడిన నల్లటి మచ్చలు ఏర్పడటం",
    ...
    organicCures: [
      {
        name: "ట్రైకోడెర్మా విరిడే (Trichoderma viride)",
        dosage: "లీటరు నీటికి 5 గ్రాముల మొదళ్ల తడిపింపు",
        application: "పూత పూసే ముందు చెట్ల మొదళ్ల వద్ద ద్రావణం పోయాలి."
      }
    ],
    chemicalCures: [
      {
  ...
  tomato_late_blight: {
    diseaseName: "టమోటా లేట్ బ్లైట్ & ఆకు మచ్చ తెగులు (Tomato Late Blight & Leaf Spot)",
    symptoms: [
      "టమోటా ఆకులపై నల్లటి నీటి మచ్చలు మరియు గోధుమ రంగు ఎండిన మచ్చలు ఏర్పడటం",
      "తేమ వాతావరణంలో ఆకు అడుగు భాగంలో తెల్లటి బూజు కనబడటం",
      "కొమ్మలు నల్లబడి టమోటా మొక్కలు కుళ్ళిపోవడం"
    ],
    rootCauses: [
      "వాతావరణంలో అధిక తేమ (>85%) మరియు చల్లటి గాలి (18°C-24°C)",
      "వర్షపు చినుకుల వల్ల గాలి ద్వారా శిలీంధ్ర వ్యాప్తి"
    ],
    organicCures: [
      {
        name: "కాపర్ హైడ్రాక్సైడ్ (Kocide) + ట్రైకోడెర్మా విరిడే",
        dosage: "లీటరు నీటికి 2.5 గ్రా కాపర్ + 5 గ్రా ట్రైకోడెర్మా",
        application: "ఉదయాన్నే మంచు ఆరకముందే ఆకులపై పిచికారీ చేయాలి."
      }
    ],
    chemicalCures: [
      {
        name: "సింజెంటా రిడోమిల్ గోల్డ్ (Ridomil Gold 2.5g/L)",
        dosage: "లీటరు నీటికి 2.0 నుండి 2.5 గ్రాములు",
        application: "వ్యాధి తీవ్రత ఉన్నప్పుడు 10 రోజుల వ్యవధిలో పిచికారీ చేయాలి.",
        phiDays: 14
      },
      {
        name: "అమిస్టార్ (Azoxystrobin 1ml/L) లేదా జటాయు (Chlorothalonil 2g/L)",
        dosage: "లీటరు నీటికి 1 మి.లీ లేదా 2 గ్రాములు",
        application: "మార్చి మార్చి పిచికారీ చేయాలి.",
        phiDays: 7
      }
    ],
    preventionProtocol: [
      "బిందు సేద్యం (Drip) వాడాలి, ఆకులపై నీరు నిల్వ ఉండకూడదు",
      "వ్యాధి సోకిన కింది ఆకులను కత్తిరించి నాశనం చేయాలి"
    ],
    mineralDeficiency: "కాల్షియం (Calcium) లోపం వల్ల కాయల అడుగు భాగం నల్లబడి కుళ్ళిపోవడం (Blossom End Rot)."
  },
  chilli_leaf_curl: {
  ...
  healthy_leaf: {
    ...
    symptoms: [
      "ఆకు అంతటా ఏకరూప ఆకుపచ్చ రంగు కలిగి ఉండటం"
    ],
    rootCauses: [
      "సరైన నీటి యాజమాన్యం మరియు ఎరువుల సమతుల్యత"
    ],
    organicCures: [
      {
        name: "సముద్రపు పాచి కషాయం (Seaweed Extract)",
        dosage: "లీటరు నీటికి 2 మి.లీ",
        application: "నెలకు ఒకసారి పిచికారీ చేయాలి."
      }
    ],
    chemicalCures: [
      {
